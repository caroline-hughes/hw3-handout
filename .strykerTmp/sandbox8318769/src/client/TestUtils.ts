...
export function anotherLocInConversation(conversation: ServerConversationArea): UserLocation {
  const loc: UserLocation = {
    moving: false,
    rotation: 'front',
    x: 26,
...
export function nonConversationAreaLoc(): UserLocation {
  const loc: UserLocation = {
    moving: false,
    rotation: 'front',
    x: 0,
